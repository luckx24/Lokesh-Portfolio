# 🚀 Lokesh's Production React Portfolio
### **AWS EKS Deployment | Full-Stack DevOps Engineer**
*Docker ⮕ EKS ⮕ Production Live!*

---

## 🎬 Deployment Journey
An end-to-end DevOps pipeline for deploying a high-availability React application.

1.  **🐳 Docker Containerization:** React portfolio containerized for production.
2.  **🐙 AWS ECR Pushed:** Image stored in private repository (`267418657844.dkr.ecr.ap-south-1`).
3.  **☸️ EKS Cluster Live:** Kubernetes v1.32.9 cluster provisioned in `ap-south-1`.
4.  **⚙️ Resource Optimization:** Resolved `t3.micro` "Too many pods" error via limits.
5.  **🌐 AWS ALB LoadBalancer:** Configured for a production-ready HTTPS URL.
6.  **🔥 Troubleshooting Master:** Hands-on experience with pod scheduling and node scaling.

🔗 **Live Production URL:** [Click Here to View](http://a9679b283309042349150b9f40e75805-267062007.ap-south-1.elb.amazonaws.com)
